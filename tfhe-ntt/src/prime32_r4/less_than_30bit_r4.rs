...
#[cfg(feature = "avx512")]
#[inline(always)]
pub(crate) fn inv_last_butterfly_avx512_r4(
    simd: crate::V4,
    z0: u32x16,
    z1: u32x16,
    w: u32x16,
...
#[cfg(any(target_arch = "x86", target_arch = "x86_64"))]
#[inline(always)]
pub(crate) fn inv_last_butterfly_avx2_r4(
    simd: crate::V3,
    z0: u32x8,
    z1: u32x8,
    w: u32x8,
...
#[inline(always)]
pub(crate) fn inv_last_butterfly_scalar_r4(
    z0: u32,
    z1: u32,
    w: u32,
    w_shoup: u32,
...
pub(crate) fn inv_avx512_r4(
    ...
    super::shoup_r4_new::inv_depth_first_avx512_r4(
        ...
        #[inline(always)]
        |simd, z0, z1, w, w_shoup, p, neg_p, two_p| {
            inv_last_butterfly_avx512_r4(simd, z0, z1, w, w_shoup, p, neg_p, two_p)
        },
    )
}
...
pub(crate) fn inv_avx2_r4(
    ...
    super::shoup_r4_new::inv_depth_first_avx2_r4(
        ...
        #[inline(always)]
        |simd, z0, z1, w, w_shoup, p, neg_p, two_p| {
            inv_last_butterfly_avx2_r4(simd, z0, z1, w, w_shoup, p, neg_p, two_p)
        },
    )
}
...
pub(crate) fn fwd_scalar_r4(p: u32, data: &mut [u32], twid: &[u32], twid_shoup: &[u32]) {
    super::shoup_r4_new::fwd_depth_first_scalar_r4(
        ...
        0,
        #[inline(always)]
        |_, z0, z1, w, w_shoup, p, neg_p, two_p| {
...
pub(crate) fn inv_scalar_r4(p: u32, data: &mut [u32], twid: &[u32], twid_shoup: &[u32]) {
    super::shoup_r4_new::inv_depth_first_scalar_r4(
        ...
        #[inline(always)]
        |_, z0, z1, w, w_shoup, p, neg_p, two_p| {
            inv_last_butterfly_scalar_r4(z0, z1, w, w_shoup, p, neg_p, two_p)
        },
    )
}
